    ...
    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
        <div class="flex justify-between">
            ...
            <div class="order-last">
                <a href="{{ url('persona/') }}" class="text-teal-900 font-bold py-1 px-2 shadow-md rounded-full">
                        ...
                        <div class="form-row flex">
                            ...
                            <div class="col-auto my-1 ml-32" class="lg:ml-40 ml-10 space-x-8" >
                                <button
                                    ...
                                    <i class="fa-solid fa-file"></i> <a href="{{ url('personas/pdf') }}">PDF</a>
                                </button>
                            </div>
                            ...
                            <div class="col-auto my-1 ml-5" class="lg:ml-40 ml-10 space-x-8">
                                <button wire:click="create()"
                                    class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">
                                    <i class="fa-solid fa-plus"></i> <a href="{{ url('persona/create') }}">Registrar
                                        nueva persona</a>
                                </button>
                            </div>
                    ...
                    <table class="w-full divide-y divide-gray-200 table-auto">
                        <thead class="bg-indigo-500 text-white">
                            <tr class="text-left text-xs font-bold  uppercase">
                                ...
                                <td scope="col" class="px-6 py-3">Estado Civil</td>
                                <td scope="col" class="px-6 py-3">Fecha de nacimiento</td>
                                <td scope="col" class="px-6 py-3">Sexo</td>
                                <td scope="col" class="px-6 py-3">Usuario</td>
                                <td scope="col" class="px-6 py-3">Contrasenia</td>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @if (count($personas) <= 0)
                                <tr>
                                    <td colspan="16" class="text-xsm font-medium text-center text-white bg-red-600">No
                                        hay resultados</td>
                                </tr>
                            @else
                                @foreach ($personas as $persona)
                                    <tr class="text-sm font-medium text-gray-900">
                                        ...
                                        <td class="px-6 py-4">{{ $persona->ps_nombre }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_paterno }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_materno }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_edad }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_dni }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_correo }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_celular }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_direccion }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_estado_civil }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_fecha_nacimiento }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_sexo }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_usuario }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_password }}</td>
                                        <td class="px-6 py-4">{{ $persona->ps_rol }}</td>
                                        <td class="px-6 py-4">
