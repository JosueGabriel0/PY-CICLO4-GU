    ...
    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
        <div class="flex justify-between">
            ...
            <div class="order-last">
                <a href="{{ url('postulacion/') }}" class="text-teal-900 font-bold py-1 px-2 shadow-md rounded-full">
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <form action="{{ route('postulacion.index') }}" method="get">
                        <div class="form-row flex">
                            ...
                            <div class="col-auto my-1 ml-32" class="lg:ml-40 ml-10 space-x-8" >
                                <button
                                    ...
                                    <i class="fa-solid fa-file"></i> <a href="{{ url('postulaciones/pdf') }}">PDF</a>
                                </button>
                            </div>
                            ...
                            <div class="col-auto my-1 ml-5" class="lg:ml-40 ml-10 space-x-8">
                                <button wire:click="create()"
                                    class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">
                                    <i class="fa-solid fa-plus"></i> <a href="{{ url('postulacion/create') }}">Registrar
                                        nuevo postulacion</a>
                                </button>
                            </div>
                    ...
                    <table class="w-full divide-y divide-gray-200 table-auto">
                        <thead class="bg-indigo-500 text-white">
                            <tr class="text-left text-xs font-bold  uppercase">
                                ...
                                <td scope="col" class="px-6 py-3">Ruta CV</td>
                                <td scope="col" class="px-6 py-3">Puntaje</td>
                                <td scope="col" class="px-6 py-3">Estado</td>
                                <td scope="col" class="px-6 py-3">Egresado ID</td>
                                <td scope="col" class="px-6 py-3">Trabajo ID</td>
                            ...
                            @else
                                @foreach ($postulaciones as $postulacion)
                                    <tr class="text-sm font-medium text-gray-900">
                                        ...
                                        <td class="px-6 py-4">{{ $postulacion->pos_ruta_cv }}</td>
                                        <td class="px-6 py-4">{{ $postulacion->pos_puntaje }}</td>
                                        <td class="px-6 py-4">{{ $postulacion->pos_estado }}</td>
                                        <td class="px-6 py-4">{{ $postulacion->pos_eg_id }}</td>
                                        <td class="px-6 py-4">{{ $postulacion->pos_tra_id }}</td>
                                        <td class="px-6 py-4">
                                            ...
                                            <x-button onclick="sweetalertD()"
                                                ...
                                                <a href="{{ url('/postulacion/' . $postulacion->id . '/edit') }}">
                                                    <i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>
                                                </a>
                                            </x-button>

                                            <!-- Usamos metodos magicos -->
                                            <form action="{{ url('/postulacion/' . $postulacion->id) }}" method="post">
                                                @csrf
                                                {{ method_field('DELETE') }}
