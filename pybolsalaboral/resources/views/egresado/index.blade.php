    ...
    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
        <div class="flex justify-between">
            ...
            <div class="order-last">
                <a href="{{ url('egresado/') }}" class="text-teal-900 font-bold py-1 px-2 shadow-md rounded-full">
                        ...
                        <div class="form-row flex">
                            ...
                            <div class="col-auto my-1 ml-32" class="lg:ml-40 ml-10 space-x-8">
                                <button
                                    ...
                                    <i class="fa-solid fa-file"></i> <a href="{{ url('egresados/pdf') }}">PDF</a>
                                </button>
                            </div>
                            ...
                            <div class="col-auto my-1 ml-5" class="lg:ml-40 ml-10 space-x-8">
                                <button wire:click="create()"
                                    class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">
                                    <i class="fa-solid fa-plus"></i> <a href="{{ url('egresado/create') }}">Registrar
                                        nuevo egresado</a>
                                </button>
                            </div>
                    ...
                    <table class="w-full divide-y divide-gray-200 table-auto">
                        <thead class="bg-indigo-500 text-white">
                            <tr class="text-left text-xs font-bold  uppercase">
                                ...
                                <td scope="col" class="px-6 py-3">Anios de experiencia</td>
                                <td scope="col" class="px-6 py-3">Ruta del cv</td>
                                <td scope="col" class="px-6 py-3">Religion</td>
                                <td scope="col" class="px-6 py-3">Especialidad</td>
                                <td scope="col" class="px-6 py-3">Nivel academico</td>
                                <td scope="col" class="px-6 py-3">Persona ID</td>
                                <td scope="col" class="px-6 py-3">Institucion ID</td>
                            ...
                            @else
                                @foreach ($egresados as $egresado)
                                    <tr class="text-sm font-medium text-gray-900">
                                        ...
                                        <td class="px-6 py-4">{{ $egresado->eg_codigo }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_anios_experiencia }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_ruta_cv }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_religion }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_especialidad }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_nivel_academico }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_ps_id }}</td>
                                        <td class="px-6 py-4">{{ $egresado->eg_ins_id }}</td>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <x-button onclick="sweetalertD()"
                                                ...
                                                <a href="{{ url('/egresado/' . $egresado->id . '/edit') }}">
                                                    <i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>
                                                </a>
                                            </x-button>

                                            <!-- Usamos metodos magicos -->
                                            <form action="{{ url('/egresado/' . $egresado->id) }}" method="post">
                                                @csrf
                                                {{ method_field('DELETE') }}
