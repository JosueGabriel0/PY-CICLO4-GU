    ...
    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
        <div class="flex justify-between">
            ...
            <div class="order-last">
                <a href="{{ url('trabajo/') }}" class="text-teal-900 font-bold py-1 px-2 shadow-md rounded-full">
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <form action="{{ route('trabajo.index') }}" method="get">
                        <div class="form-row flex">
                            ...
                            <div class="col-auto my-1 ml-32" class="lg:ml-40 ml-10 space-x-8" >
                                <button
                                    ...
                                    <i class="fa-solid fa-file"></i> <a href="{{ url('trabajos/pdf') }}">PDF</a>
                                </button>
                            </div>
                            ...
                            <div class="col-auto my-1 ml-5" class="lg:ml-40 ml-10 space-x-8">
                                <button wire:click="create()"
                                    class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">
                                    <i class="fa-solid fa-plus"></i> <a href="{{ url('trabajo/create') }}">Registrar
                                        nuevo trabajo</a>
                                </button>
                            </div>
                    ...
                    <table class="w-full divide-y divide-gray-200 table-auto">
                        <thead class="bg-indigo-500 text-white">
                            <tr class="text-left text-xs font-bold  uppercase">
                                ...
                                <td scope="col" class="px-6 py-3">Fecha de Publicacion</td>
                                ...
                                <td scope="col" class="px-6 py-3">Fecha de fin</td>
                                <td scope="col" class="px-6 py-3">Requiere experiencia</td>
                                <td scope="col" class="px-6 py-3">Datos de contacto</td>
                                <td scope="col" class="px-6 py-3">Modalidad de tiempo</td>
                                ...
                                <td scope="col" class="px-6 py-3">Remunerado</td>
                                <td scope="col" class="px-6 py-3">Monto de remuneracion</td>
                                <td scope="col" class="px-6 py-3">Empresa ID</td>
                            ...
                            @else
                                @foreach ($trabajos as $trabajo)
                                    <tr class="text-sm font-medium text-gray-900">
                                        ...
                                        <td class="px-6 py-4">{{ $trabajo->tra_fecha_publicacion }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_tipo }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_categoria }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_descripcion }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_salario }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_fecha_inicio }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_fecha_fin }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_requiere_experiencia }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_datos_contacto }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_modalidad_tiempo }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_beneficios }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_modalidad }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_titulo }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_antecedentes }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_estado }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->tra_remunerado }}</td>
                                        <td class="px-6 py-4">{{ $trabajo->ps_monto_remuneracion }}</td>
                                        <td class="px-6 py-4">
                                            ...
                                            <x-button onclick="sweetalertD()"
                                                ...
                                                <a href="{{ url('/trabajo/' . $trabajo->id . '/edit') }}">
